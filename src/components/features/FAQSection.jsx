...
import { ChevronDown, BookOpen, MessageCircle, Award, Calendar } from 'lucide-react';
    ...
    <div className="bg-gradient-to-br from-[#F4511E] to-orange-400 text-white rounded-2xl p-5 shadow-xl relative overflow-hidden max-w-xs w-full">
      ...
      <div className="relative z-10">
        ...
        <button 
          ...
          className="w-full bg-white text-[#F4511E] px-4 py-2.5 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors shadow-sm flex items-center justify-center gap-2"
        >
        ...
        <div className="mt-3 text-center">
          <a 
            ...
            className="text-xs text-orange-100 hover:text-white underline underline-offset-2 transition-colors inline-flex items-center"
          >
